# Delhi Region - Backend Autoscaling Group
...
DATABASE_URL=postgresql://${var.db_user}:${var.db_password}@${e2e_dbaas_postgresql.primary.private_ip}:5432/${var.db_name}
NODE_ENV=production
CORS_ORIGINS=*
ENVFILE
